...
//                    bots.get(ai1_idx).preGameAnalysis(new GameState(pgs.clone(), utt), 2000,"test-rw");
//                    bots.get(ai2_idx).preGameAnalysis(new GameState(pgs.clone(), utt), 2000,"test-rw");
                    for (int i = 0; i < iterations; i++) {
                        ...
                        ai1.preGameAnalysis(new GameState(pgs.clone(), utt), 2000,"test-rw");
                        ai2.preGameAnalysis(new GameState(pgs.clone(), utt), 2000,"test-rw");
                        ...
                        if (visualize) w = PhysicalGameStatePanel.newVisualizer(gs, 900, 900, partiallyObservable);
