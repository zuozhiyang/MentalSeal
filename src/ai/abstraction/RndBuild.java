 ...
 * @author santi
 */
public class RndBuild extends RndAbstractAction {
    UnitType type;
    int x,y;
    PathFinding pf;
    
    public RndBuild(Unit u, UnitType a_type, int a_x, int a_y, PathFinding a_pf) {
        super(u);
        type = a_type;
        x = a_x;
        y = a_y;
    ...
    {
        if (!(o instanceof RndBuild)) return false;
        RndBuild a = (RndBuild)o;
