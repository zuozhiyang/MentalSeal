 ...
 *
 */
public class UnitActionDetailedTypeConstantDistribution2 extends UnitActionProbabilityDistribution {
    ...
    public UnitActionDetailedTypeConstantDistribution2(UnitTypeTable a_utt, double distribution[]) throws Exception {
        super(a_utt);
        ...
        if (distribution==null || distribution.length != 12) throw new Exception("distribution does not have the right number of elements!");
