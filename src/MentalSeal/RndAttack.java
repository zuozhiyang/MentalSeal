 ...
 * @author santi
 */
public class RndAttack extends RndAbstractAction {
    Unit target;
    PathFinding pf;

    public RndAttack(Unit u, Unit a_target, PathFinding a_pf) {
        super(u);
        target = a_target;
        pf = a_pf;
    }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof RndAttack)) return false;
        RndAttack a = (RndAttack) o;
