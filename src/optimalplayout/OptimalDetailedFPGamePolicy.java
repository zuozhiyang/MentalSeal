...
// * @author santi
// */
//public class OptimalDetailedFPGamePolicy {
...
//        // - new UnitActionProbabilityDistributionAI(new UnitActionDetailedTypeConstantDistribution(utt,new double[]{2.0, 1.0, 4.0, 3.0, 8.0, 8.0}), utt, "playoutai")
//        int CORES = 20;
//        String dir = "FP-Normalized-9/";
////        String map = args[0];
////        String algo = args[1];
//        int NUM_EVAL = 1000;
//        int OPTIMIZATION_ITERATIONS = 1000;
...
//        int arm_config[] = new int[]{6, 6, 6, 6, 6, 6, 6, 6, 6}; // number of possible values for each variable in the CMAB
...
//                    if (algo.equals("TS-g"))
//                        marm1 = cmab.pullTSArm(epsilon_l, epsilon_g, actual_epsilon_0);
//                    else if (algo.equals("TS-l"))
//                        marm1 = cmab.pullTSArm(epsilon_l, epsilon_g, 1);
//                    else if (algo.equals("EG-g")) {
...
//                    }
//                    UnitActionProbabilityDistributionAI pp1 = new UnitActionProbabilityDistributionAI(new UnitActionDetailedTypeConstantDistribution(utt, pp1_d), utt, "uapdai1");
//                    int mapIdx = m;
//                    for (int j = 0; j < CORES; j++) {
//                        double[] sample;
//                        if (history.isEmpty()) {
//                            sample = new double[arm_config.length];
//                        } else {
...
//                                    try {
//                                        AI ai1 = pp1;
//                                        AI ai2 = new UnitActionProbabilityDistributionAI(new UnitActionDetailedTypeConstantDistribution(utt, sample), utt, "uapdai1");
//                                        double reward = 0.5;
//                                        if (r.nextBoolean()) {
...
//                }
//                double evaluation = parallelRun(CORES, NUM_EVAL, pp_d, history, maps.get(m), maxGameLength.get(m));
//                history.add(pp_d);
...
//        UnitTypeTable utt = new UnitTypeTable();
//        Random r = new Random();
//        double pp1_d[] = new double[values1.length];
...
//                double[] sample;
//                if (values2.isEmpty()) {
//                    sample = new double[values1.length];
//                } else {
//                    sample = values2.get(r.nextInt(values2.size()));
//                }
//                double pp2_d[] = new double[values1.length];
//                for (int i = 0; i < UnitAction.NUMBER_OF_ACTION_TYPES; i++) {
//                    pp2_d[i] = (double) (sample[i]);
//                }
//                UnitActionProbabilityDistributionAI pp2 = new UnitActionProbabilityDistributionAI(new UnitActionDetailedTypeConstantDistribution(utt, pp2_d), utt, "uapdai2");
//                Runnable runnable =
//                        () -> {
//                            try {
//                                AI ai1 = pp1;
